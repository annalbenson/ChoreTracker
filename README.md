...
- Accessible via FAB from the main chore list
- Responds to natural language requests:
  - **5-minute chore** — "give me something quick to do"
  - **Daily cleaning plan** — "what should I clean today" (adapts to your cleaning style)
...
- Done / Skip per task; completion screen summarizes progress
...
### Chore List
- Add, delete (long-press), and mark done (tap)
- Stored in SQLite with completion history
...
- **UI:** Material Components 1.11, RecyclerView, ConstraintLayout, CardView
